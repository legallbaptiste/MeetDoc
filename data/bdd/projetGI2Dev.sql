...
--
-- Host: localhost:3306
-- Generation Time: Apr 26, 2020 at 12:27 PM
...
INSERT INTO `Annonce` (`id`, `titre`, `typeOffre`, `Retrocession`, `idEtablissement`, `idRecruteur`, `image`, `description`) VALUES
(2, 'Cabinet du Dr Maboul', 'Plein Temps', 80.5, 1, 21, 'https://be-mydesk.com/img/cms/Articles%20de%20blog/amenagement-cabinet-medical.jpg', 'Cabinet du docteur Maboul, spécialisé en chirugie dentaire'),
(4, 'Cabinet du Dr Raoul', 'Plein Temps', 75.5, 1, 21, 'https://www.burofacil.fr/public/img/big/bureaux-equipes5aa156dd5c66c.jpg', 'Cabinet du docteur Raoul, spécialisé dans la médecine générale'),
(5, 'Cabinet du Dr Tournier', 'Mi-temps', 60, 3, 21, 'https://i.pinimg.com/originals/4a/6b/3c/4a6b3c52508652019696f8bd2162c7a3.jpg', 'Cabinet du docteur Tournier, spécialisé dans la gynécologie');
...
INSERT INTO `AnnonceRemplacant` (`id`, `idAnnonce`, `idRemplacant`) VALUES
(1, 4, 20);
...
(1, 'Nom de l\'etablissement', 1, 'Enfant', 'Pediatre', 1, 'blablabla', 'descirptiondescirptiondescriptiondescirption', 61),
(2, 'Nom de l\'etablissement', 1, 'Enfant', 'Pediatre', 1, 'blablabla', 'descirptiondescirptiondescriptiondescirption', 62),
(3, 'Nom de l\'etablissement', 1, 'Toute', 'Generaliste', 0, 'aeaeaea', 'aaaaaaaaaaaaaaaaaaaaadddddddddddddd', 69),
(4, 'Nom de l\'etablissement', 1, 'Toute', 'Generaliste', 0, 'aeaeaea', 'aaaaaaaaaaaaaaaaaaaaadddddddddddddd', 70);
...
INSERT INTO `User` (`id`, `nom`, `prenom`, `email`, `motDePasse`, `numTel`, `idAdresse`, `cartePro`) VALUES
(19, 'Disdier', 'Yéyé', 'remplacant@eisti.eu', 'toto', '0645681890', 31, 'lienVerslimageDeLaCarte'),
(20, 'LeGall', 'Baptisite', 'remplacant2@eisti.eu', 'toto', '0669696969', 32, 'lienVerslimageDeLaCarte'),
(21, 'Toto', 'Michel', 'recruteur@eisti.eu', 'toto', '0677771890', 67, 'lienVerslimageDeLaCarte'),
(22, 'Le Gall', 'Baptiste', 'legallbapt@eisti.eu', 'totototo', '0629977341', 71, 'lienVersCartePro');
